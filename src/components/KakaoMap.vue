...
export default {
  ...
  mounted() {
    ...
    if (window.kakao && window.kakao.maps) {
      ...
      script.src =
        "//dapi.kakao.com/v2/maps/sdk.js?autoload=false&appkey=61cc89dd5d4f852a57a81b7ffd989ef6";
    ...
    displayCircle(visible) {
      ...
      if (visible) {
        ...
        this.circleLocation = [
          LatLng.getLat() +
            Math.round(
              (crypto.getRandomValues(new Int16Array(1))[0] / 65536) * 1000
            ) /
              1500000,
          LatLng.getLng() +
            Math.round(
